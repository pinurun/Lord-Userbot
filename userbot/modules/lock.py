...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Apa Yang Harus Saya Kunci? ヅ`")
            return
        else:
    ...
    try:
        ...
        await event.edit(f"`ᴘ ɪ ɴ ᴜ ʀ ᴜ ɴ Telah Mengunci {what} Untuk Obrolan Ini ヅ`")
...
async def rem_locks(event):
    ...
    try:
        ...
        await event.edit(f"`ᴘ ɪ ɴ ᴜ ʀ ᴜ ɴ Telah Membuka Kunci {what} Untuk Obrolan Ini ヅ`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Anda Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
